...
def Map(L):
  ...
  for w in L:
    ...
    if not w.isalnum():
      w = sanitize <img width="16" height="16" class="wp-smiley emoji" draggable="false" alt="(w)" src="https://s2.wp.com/wp-content/mu-plugins/wpcom-smileys/wordpress.svg" style="height: 1em; max-height: 1em;" scale="0">
